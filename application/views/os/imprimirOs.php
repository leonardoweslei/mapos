        ...
        <div class="span12">
            ...
            <div class="invoice-content">
                        ...
                        <?php } else { ?>
                            <tr>
                                ...
                                <td style="width: 18%; text-align: center">#Protocolo:
                                    <span><?php echo $result->idOs ?></span></br> </br> <span>Emissão: <?php echo date(
                                            'd/m/Y'
                                        ) ?></span></td>
                            </tr>
                    ...
                    <table class="table" style="margin-top: 0">
                        ...
                        <tr>
                            ...
                            <td style="width: 30%; padding-left: 0">
                                <ul>
                                    <li>
                                        <span><h5>Atendimento</h5></span>
                                        <span>Tipo de Atendimento: <?php echo $result->tipoAtendimento ?></span>
                                        <br/>
                                        <span>Setor/Departamento: <?php echo $result->setorDepartamento ?></span><br/>
                                            <span>
                                                Data de Execução: <?php
                                                echo(
                                                $result->dataExecucao ?
                                                    date('d/m/Y', strtotime($result->dataExecucao)) :
                                                    ''
                                                );
                                                ?>
                                            </span><br/>
                                            <span>
                                                Hora de Execução: <?php
                ...
                <div style="margin-top: 0; padding-top: 0">
                    ...
                    <h4 style="text-align: right">Valor Total: R$ <?php echo number_format(
