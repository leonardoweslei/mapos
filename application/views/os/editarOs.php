                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <input id="tipoAtendimento" type="text" class="span12"
                                                   name="tipoAtendimento"
                                                   value="<?php echo $result->tipoAtendimento ?>"/>
                                        </div>
                                        <div class="span3">
                                            <label for="setorDepartamento">Setor/Departamento</label>
                                            <input id="setorDepartamento" type="text" class="span12"
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span2">
                                            ...
                                            <input id="dataInicial" class="span12 datepicker" type="text"
                                                   name="dataInicial" value="<?php echo($result->dataInicial ? date(
                                                'd/m/Y',
                                        ...
                                        <div class="span2">
                                            ...
                                            <input id="dataFinal" class="span12 datepicker" type="text" name="dataFinal"
                                                   value="<?php echo($result->dataFinal ? date(
                                                       'd/m/Y',
                                        ...
                                        <div class="span2">
                                            ...
                                            <input id="dataExecucao" class="span12 datepicker" type="text"
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="horaExecucaoInicial" class="span12 timepicker" type="text"
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="horaExecucaoFinal" class="span12 timepicker" type="text"
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6 offset3" style="text-align: center">
                                            ...
                                            ) ?>index.php/os/visualizar/<?php echo $result->idOs; ?>"
