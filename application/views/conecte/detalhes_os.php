                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    ...
                                    <div class="span6">
                                        ...
                                        <input disabled="disabled" id="tecnico" class="span12" type="text"
                                               name="tecnico" value="<?php echo $result->nome ?>"/>
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    <div class="span3">
                                        ...
                                        <input disabled="disabled" id="tipoAtendimento" type="text" class="span12"
                                               name="tipoAtendimento"
                                               value="<?php echo $result->tipoAtendimento ?>"/>
                                    </div>
                                    <div class="span3">
                                        <label for="setorDepartamento">Setor/Departamento</label>
                                        <input disabled="disabled" id="setorDepartamento" type="text" class="span12"
                                               name="setorDepartamento"
                                               value="<?php echo $result->setorDepartamento ?>"/>
                                    </div>
                                    <div class="span3">
                                        <label for="status">Status<span class="required"></span></label>
                                        <input disabled="disabled" type="text" name="status" id="status" class="span12"
                                               value="<?php echo $result->status; ?>">

                                    </div>
                                    <div class="span3">
                                        <label for="garantia">Garantia</label>
                                        <input id="garantia" disabled="disabled" type="text" class="span12"
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    <div class="span2">
                                        ...
                                        <input id="dataInicial" disabled="disabled" class="span12 datepicker"
                                               type="text" name="dataInicial"
                                               value="<?php echo date('d/m/Y', strtotime($result->dataInicial)); ?>"/>
                                    </div>
                                    <div class="span2">
                                        <label for="dataFinal">Data Final</label>
                                        <input id="dataFinal" disabled="disabled" class="span12 datepicker" type="text"
                                               name="dataFinal"
                                               value="<?php echo date('d/m/Y', strtotime($result->dataFinal)); ?>"/>
                                    </div>
                                    <div class="span2">
                                        <label for="dataExecucao">Data de Execução</label>
                                        <input id="dataExecucao" disabled="disabled" class="span12 datepicker"
                                               type="text"
                                               name="dataExecucao" value="<?php echo($result->dataExecucao ? date(
                                            'd/m/Y',
                                            strtotime($result->dataExecucao)
                                        ) : ''); ?>"/>
                                    </div>
                                    <div class="span3">
                                        <label for="horaExecucaoInicial">Hora de Execução Inicial</label>
                                        <input id="horaExecucaoInicial" disabled="disabled" class="span12 timepicker"
                                               type="text"
                                               name="horaExecucaoInicial"
                                               value="<?php echo $result->horaExecucaoInicial; ?>"/>
                                    </div>
                                    <div class="span3">
                                        <label for="horaExecucaoFinal">Hora de Execução Final</label>
                                        <input id="horaExecucaoFinal" disabled="disabled" class="span12 timepicker"
                                               type="text"
                                               name="horaExecucaoFinal"
                                               value="<?php echo $result->horaExecucaoFinal; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    ...
                                    <div class="span6">
                                        ...
                                        <textarea disabled="disabled" class="span12" name="descricaoProduto"
                                                  id="descricaoProduto" cols="30"
                                                  rows="5"><?php echo $result->descricaoProduto ?></textarea>
                                    </div>
                                    <div class="span6">
                                        <label for="defeito">Defeito</label>
                                        <textarea disabled="disabled" class="span12" name="defeito" id="defeito"
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    <div class="span6">
                                        ...
                                        <textarea disabled="disabled" class="span12" name="observacoes" id="observacoes"
                                                  cols="30" rows="5"><?php echo $result->observacoes ?></textarea>
                                    </div>
                                    <div class="span6">
                                        <label for="laudoTecnico">Laudo Técnico</label>
                                        <textarea disabled="disabled" class="span12" name="laudoTecnico"
                                ...
                                <table class="table table-bordered" id="tblProdutos">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>R$ <?php echo number_format($total, 2, ',', '.'); ?><input
                                                    ...
                                                    value="<?php echo number_format($total, 2); ?>"></strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <?php if ($this->session->userdata('cliente_anexa')) { // cliente pode anexar itens?>
                                    <div class="span12 well" style="padding: 1%; margin-left: 0" id="form-anexos">
                                        <form id="formAnexos" enctype="multipart/form-data" action="javascript:;"
                                            ...
                                            <div class="span2">
                                                <label for="">.</label>
                                                <button class="btn btn-success span12"><i
