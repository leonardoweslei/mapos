                                    ...
                                    <table class="table table-condensed">
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                ...
                                                <td><span
                                                        style="font-size: 20px; "> <?php echo $emitente[0]->nome; ?></span> </br>
                                    ...
                                    <?php if ($produtos != null || $servicos != null) { ?>
                                        ...
                                        <table class="table table-condensed" id="tblProdutos">
                                            ...
                                            foreach ($produtos as $p) {
                                                ...
                                                echo '<td style="text-align: center">R$ ' . number_format(
                                                        $p->subTotal,
                                                        2,
                                                        ',',
                                                        '.'
...
<!--Footer-part-->
<div class="row-fluid">
    <div id="footer" class="span12"> <?= date('Y') ?> &copy; <?php echo $this->config->item('app_name'); ?> -
        Versão <?php echo $this->config->item('app_version'); ?></div>
</div>
